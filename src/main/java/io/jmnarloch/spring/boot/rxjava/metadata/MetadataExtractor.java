...
public class MetadataExtractor {
    ...
    private <A extends Annotation> AnnotationInspector<A> using(Class<A> annotationType) {
        return new AnnotationInspector<>(method, annotationType);
    }
}
